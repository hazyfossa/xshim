...
pub trait Session {
    ...
    /// ExtraDeviceAccess property
    #[zbus(property)]
    fn extra_device_access(&self) -> zbus::Result<Vec<String>>;
    ...
    /// LeaderPIDFDId property
    #[zbus(property, name = "LeaderPIDFDId")]
    fn leader_pidfdid(&self) -> zbus::Result<u64>;
